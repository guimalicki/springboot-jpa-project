...
public class ResourceExceptionHandler {
    ...
    public ResponseEntity<StandardError> resourceNotFound(ResourceNotFoundExpection resourceNotFoundExpection, HttpServletRequest request) {
        String error = "Resource not found";
        HttpStatus status = HttpStatus.NOT_FOUND;
        StandardError err = new StandardError(Instant.now(), status.value(), error, resourceNotFoundExpection.getMessage(), request.getRequestURI());
