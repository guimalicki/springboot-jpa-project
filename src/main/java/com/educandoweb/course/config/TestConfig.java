...
public class TestConfig implements CommandLineRunner { //essa implementação faz essa classe rodar quando a aplicação iniciar
    ...
    public void run(String... args) throws Exception { //O que irá rodar quando iniciar a aplicação
        ...
        Order o1 = new Order(null, Instant.parse("2019-06-20T19:53:07Z"), s1); //Data no formato ISO 8601. Z é o patrão UTC
        Order o2 = new Order(null, Instant.parse("2019-07-21T03:42:10Z"), s2);
        Order o3 = new Order(null, Instant.parse("2019-07-22T15:21:22Z"), s1);
